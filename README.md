...
#### 2. 파일이름: [gw2humanch2.txt](https://github.com/deejaykoo/gw2krtranslation/blob/main/gw2humanch2.txt) - 번역내용: 인간족 스토리 챕터2 + Kessex Hills지역과 Gendarran Fields 지역의 돌발 퀘스트와 명성하트 퀘스트

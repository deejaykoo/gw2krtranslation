...
- 추가: 안녕하세요, 길드워2 번역 DB를 만들고 있는 디제이쿠입니다.

죄송하지만 현재 일이 조금 바빠서 챕터5의 번역의 진도를 못 나갔습니다.

(그리고 다른겜 일탈도 조금 하고 있고요;;)

빨리 끝난다면 다음 주말이 될것 같고, 예상은 그 다음 주말이나 그 전에 완성될것 같네요.

가능한 최대한 빨리 챕터5의 번역 DB를 완성하겠습니다. 
...
- #### 추가: 개발자님께서 블로그에 이 번역의 [소개글](https://blog.naver.com/killkimno/222560178847)을 작성해 주셨습니다. 해당 글에서도 설명이 잘 되어 있으니 제 설명 대신 소개글에 방문하셔서 개발자님의 설명을 보셔도 됩니다. 
